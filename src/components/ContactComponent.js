...
class Contact extends Component {
    ...
    handleSubmit(event){
        console.log( "cuurent state is :" + JSON.stringify(this.state));
        alert("cuurent state is :" + JSON.stringify(this.state));
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3)
          errors.firstname = "firstname should be greater than 3 characters";
            ...
            errors.telnum = 'TEL should contain only numbers';
            
            if(this.state.touched.email && email.split('').filter(x => x === '@').length !==1)
            errors.emails = "email should contain a @ sign";
